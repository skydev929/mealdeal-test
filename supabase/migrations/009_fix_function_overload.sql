...
-- Drop all existing versions of calculate_dish_price and create a single version

-- Drop all versions of the function (with different signatures)
DROP FUNCTION IF EXISTS calculate_dish_price(TEXT, TEXT);
DROP FUNCTION IF EXISTS calculate_dish_price(UUID, TEXT);
DROP FUNCTION IF EXISTS calculate_dish_price(TEXT);
DROP FUNCTION IF EXISTS calculate_dish_price(UUID);
DROP FUNCTION IF EXISTS public.calculate_dish_price(TEXT, TEXT);
DROP FUNCTION IF EXISTS public.calculate_dish_price(UUID, TEXT);

-- Also drop convert_unit to be safe
DROP FUNCTION IF EXISTS convert_unit(DECIMAL, TEXT, TEXT);

-- Recreate convert_unit function
...
-- Create single version of calculate_dish_price with explicit TEXT type
